...
def test_path_to_date():
    ...
    pats = [
        ...
        ["foo.jpg",         None],
        ["/Users/simsong/Pictures/1985 County/1985-07County  _193.jpg", date(1985,7,1)],
        ["/Users/simsong/Dropbox (foobar)/photox/photo/2010-06-13 person whale034.pdf-000.jpg", date(2010,6,13)],
        ["1980-01/1980-02-03.jpg", date(1980,2,3)],
        ["1980-01/untitled 4.jpg", date(1980,1,1)],
        ]
    for (old,new) in pats:
        print("{} => {}".format(old,new))
